    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Why Partners
          <br />
          <span className="text-gradient font-medium">Choose Minture</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          Enable automated Web3 investments for your users with our secure, non-custodial SIP-as-a-Service platform.
        </p>
      </div>
